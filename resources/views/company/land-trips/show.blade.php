                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><strong>تاريخ المغادرة:</strong> {{ Carbon\Carbon::parse($landTrip->departure_date)->format('d/m/Y') }}</li>
                                <li><strong>تاريخ العودة:</strong> {{ Carbon\Carbon::parse($landTrip->return_date)->format('d/m/Y') }}</li>
                                ...
                                <tbody>
                                    @foreach($companyBookings as $index => $booking)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('company.land-trips.voucher', $booking->id) }}" class="btn btn-sm btn-primary">
                                                    الفاتورة
                                                </a>
                                            </td>
                                        </tr>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('company.land-trips.book', $landTrip->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="land_trip_room_price_id" class="form-label">نوع الغرفة <span class="text-danger">*</span></label>
