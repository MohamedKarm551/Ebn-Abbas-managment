                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="trip_type_id" name="trip_type_id">
                        ...
                        @foreach($tripTypes as $tripType)
                            <option value="{{ $tripType->id }}" {{ request('trip_type_id') == $tripType->id ? 'selected' : '' }}>
                                {{ $tripType->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled">
                            ...
                            <li><strong>تاريخ المغادرة:</strong> {{ Carbon\Carbon::parse($trip->departure_date)->format('d/m/Y') }}</li>
                            <li><strong>تاريخ العودة:</strong> {{ Carbon\Carbon::parse($trip->return_date)->format('d/m/Y') }}</li>
