...
@section('title', 'إضافة ألوتمنت جديد')
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">إضافة ألوتمنت جديد</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" name="rooms_count" id="rooms_count" 
                                    ...
                                    value="{{ old('rooms_count') }}" min="1" required>
                                @error('rooms_count')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" name="rate_per_room" id="rate_per_room" 
                                    ...
                                    value="{{ old('rate_per_room') }}" min="0" step="0.01">
                                @error('rate_per_room')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save ml-1"></i> حفظ الألوتمنت
                                </button>
