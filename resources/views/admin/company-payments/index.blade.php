        ...
        <div class="col-md-3">
            <div class="card bg-info text-white border-0 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h6 class="mb-1">{{ number_format($totalStats['total_paid_sar'] + $totalStats['total_paid_kwd'], 2) }}</h6>
            ...
            <form method="GET" class="row g-3 align-items-end">
                <div class="col-md-6">
                    ...
                    <input type="text" name="search" class="form-control search-box" 
                           placeholder="اسم الشركة..." value="{{ request('search') }}">
                </div>
                <div class="col-md-3">
            ...
            <div class="card company-card shadow-sm border-0 h-100">
                ...
                <div class="card-body">
                            ...
                            <div class="bg-light rounded p-2">
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <strong class="text-success">{{ number_format($company['totals_by_currency']['SAR']['paid'], 2) }}</strong>
                                    </div>
                                    <div class="col-4">
                                        <small class="text-muted d-block">المتبقي</small>
                                        <strong class="text-danger">{{ number_format($company['totals_by_currency']['SAR']['remaining'], 2) }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-2">
                            <div class="bg-light rounded p-2">
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-4">
                                        <small class="text-muted d-block">المدفوع</small>
                                        <strong class="text-success">{{ number_format($company['totals_by_currency']['KWD']['paid'], 2) }}</strong>
                                    </div>
                                    <div class="col-4">
                                        <small class="text-muted d-block">المتبقي</small>
                                        <strong class="text-danger">{{ number_format($company['totals_by_currency']['KWD']['remaining'], 2) }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-top pt-2">
                        ...
                        <small class="d-block">
                            {{ number_format($company['last_payment']->amount, 2) }} {{ $company['last_payment']->currency }}
                            <span class="text-muted">- {{ $company['last_payment']->payment_date->format('d/m/Y') }}</span>
                        </small>
                    </div>
                    @endif
                </div>
