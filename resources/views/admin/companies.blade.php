    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $company->name }}</td>
                <td>
                    <a href="{{ route('admin.editCompany', $company->id) }}" class="btn btn-warning btn-sm">تعديل</a>
                    <form action="{{ route('admin.deleteCompany', $company->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
