                        ...
                        <tbody>
                            @foreach($bookings as $index => $booking)
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($booking->amount_due_from_company, 2) }} {{ $currencySymbol }}</td>
                                    <td>{{ number_format($booking->amount_paid_by_company ?? 0, 2) }} {{ $currencySymbol }}</td>
                                    <td>{{ number_format(($booking->amount_due_from_company - ($booking->amount_paid_by_company ?? 0)), 2) }} {{ $currencySymbol }}</td>
                                    <td>
