        ...
        <div class="card-header bg-warning text-dark py-2">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-sm btn-dark" 
                        ...
                        data-bs-target="#unassignedBookingsCollapse" 
                        aria-expanded="true"
                    ...
                    <table class="table table-striped table-hover mb-0 align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fw-medium">{{ $booking->client_name }}</td>
                                <td>
                                    <span class="badge bg-info">{{ $booking->hotel->name }}</span>
                                </td>
                                <td>{{ $booking->company->name ?? 'غير محدد' }}</td>
                                <td class="text-center">
                                    <span class="badge bg-secondary">{{ $booking->check_in->format('Y-m-d') }}</span>
                                </td>
                                <td class="text-center">
                                    <span class="badge bg-secondary">{{ $booking->check_out->format('Y-m-d') }}</span>
                                </td>
                                <td class="text-center">
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
            <div class="card h-100 shadow-sm hotel-card position-relative overflow-hidden">
                ...
                @if(isset($unassignedBookingsByHotel[$hotel->id]) 
                    && $unassignedBookingsByHotel[$hotel->id]->count() > 0)
