...
@section('content')
    <div class="container-fluid">
        ...
        <!-- مخطط الحالة المالية -->
        <button class="btn btn-link bg-warning text-dark mb-3" style="width: 100%; text-align: center;">
            <a class="nav-link {{ Request::is('reports/financial*') ? 'active' : '' }}"
                href="{{ route('financial.status.index') }}">
                <i class="fas fa-money-bill-wave fa-fw"></i>
                <span> الذهاب إلى مخطط الحالة المالية</span>
            </a>
        </button>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div id="network-graph"
                    style="height: 700px; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;"></div>
