                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    ...
                                                    $tripPayments = $company->payments
                                                        ->groupBy('currency')
                                                        ->map(function ($payments, $currency) {
                                                            return [
                                                                'paid' => $payments
                                                                    ->where('amount', '>=', 0)
                                                                    ->sum('amount'),
                                                    ...
                                                    foreach (['SAR', 'KWD'] as $cur) {
                                                        ...
                                                        $paid = $tripPayments[$cur]['paid'] ?? 0;
                                                        $discounts = $tripPayments[$cur]['discounts'] ?? 0;
                                    ...
                                    <tr class="table-secondary fw-bold">
                                        ...
                                        <td>
                                            ...
                                            @foreach ($totalPaidByCurrency as $currency => $paid)
                                                <div class="mb-1">
                                                    <strong
                                                        class="text-success">{{ number_format((float) $paid, 2) }}</strong>
                                                    {{ $currency === 'SAR' ? 'ريال' : 'دينار' }}
                                                </div>
                                            @endforeach
                                        </td>
