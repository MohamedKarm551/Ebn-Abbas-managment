...
@push('styles')
    <style>
        ...
        .receipt-text:hover {
            border-color: #007bff;
            /* إظهار الحدود عند التمرير */
            background: rgba(0, 123, 255, 0.1);
        }

        .receipt-text.dragging {
            border-color: #ff6b6b;
            /* لون مختلف أثناء السحب */
...
@section('content')
    ...
    <div class="position-controls" id="positionControls" style="display: none;">
        ...
        <button onclick="toggleControls()"
            style="margin-top: 10px; padding: 5px 10px; background: #ff6b6b; color: white; border: none; border-radius: 5px;">إخفاء</button>
    </div>
    ...
    <div class="receipt-container">
        ...
        <div class="receipt-image" id="receiptImage">
            <div class="receipt-overlay">
                ...
                <!-- التاريخ العربي -->
                <div class="receipt-text" id="receiptDateArabic" style="top: 308px; right: 115px; font-size: 14px;">
                </div>

                <!-- التاريخ الإنجليزي -->
                <div class="receipt-text" id="receiptDateEnglish" style="top: 314px; right: 718px; font-size: 14px;">
                </div>

                <!-- اسم الدافع -->
                <div class="receipt-text" id="payerName"
                    style="top: 359px; right: 285px; font-size: 14px; max-width: 600px;"></div>

                <!-- المبلغ -->
                <div class="receipt-text" id="amountText"
                    style="top: 402px; right: 150px; font-size: 14px; max-width: 600px;"></div>

                <!-- وذلك عن -->
                <div class="receipt-text" id="subjectText"
                    style="top: 455px; right: 128px; font-size: 14px; max-width: 650px;"></div>

                <!-- علامة صح للنقد -->
                <div class="receipt-text" id="cashCheck"
                    style="top: 501px; right: 65px; font-size: 18px; display: none;">✓</div>

                <!-- علامة صح للشيك -->
                <div class="receipt-text" id="checkMark"
                    style="top: 498px; right: 156px; font-size: 18px; display: none;">✓</div>
                ...
                <!-- التوقيعات -->
                <div class="receipt-text" id="receiverSignature" style="bottom: 87px; right: 96px; font-size: 21px;">
                    المستلم</div>
                <div class="receipt-text" id="accountantSignature" style="bottom: 90px; right: 425px; font-size: 20px;">
                    المحاسب</div>
                <div class="receipt-text" id="managerSignature" style="bottom: 91px; right: 692px; font-size: 19px;">محمد
                    حسن عباس</div>
            </div>
        </div>
            ...
            <div class="modern-form">
                ...
                <form id="receiptForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="accountantSig"
                                    name="accountant_signature" placeholder="اسم المحاسب" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        <button type="button" onclick="toggleControls()" class="btn-generate"
...
@push('scripts')
  ...
  <script>
        // عند تغيير التاريخ الميلادي يتم تحويله للهجري وملء الحقل تلقائياً
    document.getElementById('dateEnglish').addEventListener('change', function() {
        ...
        if (gregorianDate) {
            try {
                ...
                document.getElementById('dateArabic').value = hijriDate;
            } catch (e) {
                document.getElementById('dateArabic').value = '';
            }
        }
    });
