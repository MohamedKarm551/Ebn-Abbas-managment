                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $discountsByCurrency =
                                                    $agent->computed_total_discounts_by_currency ?? [];
                                            ...
                                            @if (isset($paidByCurrency['SAR']) && ($paidByCurrency['SAR'] > 0 || ($discountsByCurrency['SAR'] ?? 0) > 0))
                                                <div class="mb-1">
                                                    ...
                                                    @if (($discountsByCurrency['SAR'] ?? 0) > 0)
                                                        <br><small class="text-warning">
                                                            <i class="fas fa-minus-circle me-1"></i>
                                                            خصومات: {{ number_format($discountsByCurrency['SAR'], 2) }}
                                                            ريال
                                                        </small>
                                                    @endif
                                                </div>
                                            ...
                                            @if (isset($paidByCurrency['KWD']) && ($paidByCurrency['KWD'] > 0 || ($discountsByCurrency['KWD'] ?? 0) > 0))
                                                <div class="mb-1">
                                                    ...
                                                    @if (($discountsByCurrency['KWD'] ?? 0) > 0)
                                                        <br><small class="text-warning">
                                                            <i class="fas fa-minus-circle me-1"></i>
                                                            خصومات: {{ number_format($discountsByCurrency['KWD'], 2) }}
                                                            دينار
                                                        </small>
                                                    @endif
                                                </div>
...
<td>
    <div style="display: flex; flex-wrap: wrap; gap: 5px; justify-content: center;">
        <a href="{{ route('reports.agent.bookings', $agent->id) }}"
            ...
            style="flex: 1 1 calc(50% - 5px); min-width: 120px;">عرض الحجوزات</a>

        <button type="button"
            class="btn btn-success btn-sm"
            style="flex: 1 1 calc(50% - 5px); min-width: 120px;"
        ...
        <a href="{{ route('reports.agent.payments', $agent->id) }}"
            ...
            style="flex: 1 1 calc(50% - 5px); min-width: 120px;">كشف حساب</a>
    </div>
</td>
