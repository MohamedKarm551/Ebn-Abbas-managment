@extends('layouts.app')
@section('title', 'ملخص حسابات الموردين')
...
<div class="container-fluid mt-4">
    <div class="card">
        <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
            <h4 class="mb-0"><i class="fas fa-truck me-2"></i> ملخص حسابات الموردين (جهات الحجز)</h4>
            ...
            <div class="d-flex gap-2 mb-3 no-print">
                ...
                <a href="{{ route('accounts.statements.suppliers', array_merge(request()->query(), ['export' => 'excel'])) }}" class="btn btn-success btn-sm">
                    <i class="fas fa-file-excel me-1"></i> Excel
                </a>
                <a href="{{ route('accounts.statements.suppliers', array_merge(request()->query(), ['export' => 'pdf'])) }}" class="btn btn-danger btn-sm">
        ...
        <div class="card-body">
            ...
            {{-- فلتر بنطاق تاريخي --}}
            <form method="GET" action="{{ route('accounts.statements.suppliers') }}" class="row g-3 align-items-end mb-4 no-print">
                <div class="col-md-3">
                ...
                <div class="col-md-auto d-flex gap-2">
                    ...
                    <a href="{{ route('accounts.statements.suppliers') }}" class="btn btn-secondary">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">لا توجد حسابات موردين تطابق معايير البحث</td>
                            </tr>
                        @endforelse
                    </tbody>
