...
<x-slot name="title">
    {{ isset($isEdit) ? 'تعديل ايصال صرف' : 'ايصال صرف' }}
</x-slot>
...
<div class="voucher-page">
    <div class="voucher-wrapper">
        ...
        <div class="receipt-canvas" id="paymentCanvas">
            ...
            <div class="acc-wrap-inline" id="debitWrap" style="top:50.5%; right:33%; width:42%; font-size:1.35vw;">
            ...
            {{-- الحساب المقابل (الدائن) – الخزينة أو البنك --}}
...
<script>
    ...
    document.getElementById('btnDl').addEventListener('click', function () {
        ...
        html2canvas(document.getElementById('paymentCanvas'), { scale: 3, useCORS: true, backgroundColor: null })
            .then(c => {
                // إعادة الإظهار
